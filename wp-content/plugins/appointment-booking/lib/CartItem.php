...
class CartItem
{
    ...
    public function getServicePrice()
    {
        ...
        if ( $special_hours_enabled ) {
            // Check service price for selected hour.
            ...
            if ( isset ( self::$service_prices[ $staff_id ][ $service_id ][ $service_start ] ) ) {
                $service_price = self::$service_prices[ $staff_id ][ $service_id ][ $service_start ];
            }
        } else {
            if ( isset ( self::$service_prices[ $staff_id ][ $service_id ] ) ) {
                $service_price = self::$service_prices[ $staff_id ][ $service_id ];
            }
        }
        ...
        if ( $service_price === null ) {
            ...
            if ( $special_hours_enabled ) {
                ...
                self::$service_prices[ $staff_id ][ $service_id ][ $service_start ] = $service_price;
            } else {
