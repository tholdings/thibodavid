            ...
            case 'staff_agenda':
                if ( $date->format( 'H' ) >= $hours[ $notification->get( 'type' ) ] ) {
                    ...
                    if ( $rows ) {
                        ...
                        ksort( $columns );
                        $is_html = ( get_option( 'bookly_email_content_type' ) == 'html' && $notification->get( 'gateway' ) != 'sms' );
                        if ( $is_html ) {
                        ...
                        foreach ( $appointments as $staff_id => $collection ) {
                            ...
                            if ( $staff_email || $staff_phone ) {
                                ...
                                if ( $notification->get( 'gateway' ) == 'email' && $staff_email ) {
                                    ...
                                    $message = get_option( 'bookly_email_content_type' ) == 'plain' ? $message : wpautop( $message );
                                    // Send email.
