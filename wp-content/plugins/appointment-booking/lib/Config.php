...
abstract class Config
{
    ...
    {
        return array( 'AED', 'ARS', 'AUD', 'BGN', 'BHD', 'BRL', 'CAD', 'CHF', 'CLP', 'COP', 'CRC', 'CZK', 'DKK', 'EGP', 'EUR', 'GBP', 'GEL', 'GTQ', 'HKD', 'HRK', 'HUF', 'IDR', 'ILS', 'INR', 'ISK', 'JPY', 'KES', 'KRW', 'KZT', 'LAK', 'MUR', 'MXN', 'MYR', 'NAD', 'NGN', 'NOK', 'NZD', 'OMR', 'PEN', 'PHP', 'PKR', 'PLN', 'QAR', 'RMB', 'RON', 'RUB', 'SAR', 'SEK', 'SGD', 'THB', 'TRY', 'TWD', 'UAH', 'UGX', 'USD', 'VND', 'XOF', 'ZAR', 'ZMW', );
    }
    ...
    {
        $gateways = array(
            Entities\Payment::TYPE_2CHECKOUT    => 'bookly_pmt_2checkout',
            Entities\Payment::TYPE_AUTHORIZENET => 'bookly_pmt_authorizenet',
            Entities\Payment::TYPE_LOCAL        => 'bookly_pmt_pay_locally',
            Entities\Payment::TYPE_MOLLIE       => 'bookly_pmt_mollie',
            Entities\Payment::TYPE_PAYPAL       => 'bookly_pmt_paypal',
            Entities\Payment::TYPE_PAYSON       => 'bookly_pmt_payson',
            Entities\Payment::TYPE_PAYULATAM    => 'bookly_pmt_payu_latam',
            Entities\Payment::TYPE_STRIPE       => 'bookly_pmt_stripe',
        );
        switch ( $gateway ) {
            ...
            default:
                foreach ( $gateways as $option_name ) {
                    if ( get_option( $option_name ) != 'disabled' ) {
                        return false;
                    }
                }
        }
    ...
    {
        return Utils\Common::isPluginActive( 'bookly-addon-service-schedule/main.php' );
    }
    ...
    {
        return Utils\Common::isPluginActive( 'bookly-addon-special-days/main.php' );
    }
    ...
    {
        return Utils\Common::isPluginActive( 'bookly-addon-special-hours/main.php' );
    }
