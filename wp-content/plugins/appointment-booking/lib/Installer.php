...
class Installer extends Base\Installer
{
    ...
    public function __construct()
    {
        ...
        $this->options = array(
            ...
            'bookly_email_content_type'                  => 'html',
            ...
            'bookly_gen_show_subscribe_notice'           => '1',
            // Cron.
    ...
    public function uninstall()
    {
        ...
        $meta_dismiss_admin_notice = Plugin::getPrefix() . 'dismiss_admin_notice';
        $meta_filter_appointments  = Plugin::getPrefix() . 'filter_appointments_list';
        // Remove user meta.
        foreach ( get_users( array( 'role' => 'administrator' ) ) as $admin ) {
            delete_user_meta( $admin->ID, $meta_dismiss_admin_notice );
            delete_user_meta( $admin->ID, $meta_filter_appointments );
        }
    }
    ...
    public function createTables()
    {
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\Payment::getTableName() . '` (
                ...
                `type`              ENUM("local","coupon","paypal","authorizeNet","stripe","2checkout","payu_latam","payson","mollie","woocommerce") NOT NULL DEFAULT "local",
