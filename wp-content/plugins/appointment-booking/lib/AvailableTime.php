...
class AvailableTime
{
    ...
    public function __construct( UserBookingData $userData )
    {
        ...
        $this->client_diff         = get_option( 'bookly_gen_use_client_time_zone' )
    ...
    private function _prepareStaffData()
    {
        ...
        // Load special days.
        $special_days = apply_filters( 'bookly_special_days_get_data_for_available_time', array(), array_keys( $this->staff_data ) );
