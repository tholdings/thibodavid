...
class Controller extends Lib\Base\Controller
{
    ...
    public function approved()
    {
        ...
        if ( $userData->load() ) {
            ...
            $StringToHash = strtoupper( md5( get_option( 'bookly_pmt_2checkout_api_secret_word' ) . get_option( 'bookly_pmt_2checkout_api_seller_id' ) . $this->getParameter( 'order_number' ) . $amount ) );
