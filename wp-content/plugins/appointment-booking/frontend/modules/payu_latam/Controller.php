...
class Controller extends Lib\Base\Controller
{
    ...
    public function checkout()
    {
        ...
        if ( false === Lib\Payment\PayuLatam::paymentIsApproved( ( get_option( 'bookly_pmt_payu_latam_sandbox' ) == 1 ), $transactionState, $this->getParameter( 'referenceCode' ), $this->getParameter( 'transactionId' ), $this->getParameter( 'signature' ) ) ) {
