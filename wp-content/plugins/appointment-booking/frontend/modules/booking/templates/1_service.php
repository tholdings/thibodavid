        ...
        <div class="ab-row">
            <div class="ab-left ab-mob-float-none">
                <div class="ab-available-date ab-left ab-mob-float-none">
                    <div class="ab-formGroup">
                        <span class="ab-bold"><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_select_date' ) ?></span>
                        <div>
            ...
            <?php if ( ! empty ( $times ) ) : ?>
                <div class="ab-time-range ab-left ab-mob-float-none">
                    <div class="ab-formGroup ab-time-from ab-left">
                        <span class="ab-bold"><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_start_from' ) ?></span>
                        <div>
                    ...
                    <div class="ab-formGroup ab-time-to ab-left">
                        <span class="ab-bold"><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_finish_by' ) ?></span>
                        <div>
