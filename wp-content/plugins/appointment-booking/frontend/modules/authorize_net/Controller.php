    ...
    public function executeAuthorizeNetAIM()
    {
        ...
        if ( $userData->load() ) {
            ...
            if ( $failed_cart_key === null ) {
                ...
                $authorize = new Lib\Payment\AuthorizeNet( get_option( 'bookly_pmt_authorizenet_api_login_id' ), get_option( 'bookly_pmt_authorizenet_transaction_key' ), (bool) get_option( 'bookly_pmt_authorizenet_sandbox' ) );
