jQuery(function($) {
    ...
    function onCollapseInitChildren() {
        $('.panel-collapse').on('show.bs.collapse.bookly', function () {
            ...
            $panel.find('.js-reset').on('click', function () {
                ...
                $panel.find('.parent-range-beg').trigger('change');
                updateStaffButton($panel);
            });
    ...
    }).on('change', '.popover-range-beg, .popover-range-end', function () {
        var $popover_content = $(this).closest('.popover-content');
        serviceTools.hideInaccessibleBreaks($popover_content.find('.popover-range-beg'), $popover_content.find('.popover-range-end'), true);
    });
    ...
    window.serviceTools = {
        ...
        hideInaccessibleEndTime: function( $start, $end, force_keep_values ) {
            ...
            $('option', $end).each(function () {
                if ((this.value <= $start.val()) && (!force_keep_values || this.value != old_value)) {
