        ...
        <form action="<?php echo admin_url( 'admin-ajax.php?action=bookly_export_customers' ) ?>" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="checkbox"> <label> <input checked value="<?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_name' ) ?>" name="exp[name]" type="checkbox"> <?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_name' ) ?> </label> </div>
                        ...
                        <div class="checkbox"> <label> <input checked value="<?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_phone' ) ?>" name="exp[phone]" type="checkbox"> <?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_phone' ) ?> </label> </div>
                        <div class="checkbox"> <label> <input checked value="<?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_email' ) ?>" name="exp[email]" type="checkbox"> <?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_email' ) ?> </label> </div>
