        ...
        $.get(ajaxurl, { action: 'bookly_edit_staff', id: staff_id }, function (response) {
            ...
            $delete_staff_button.on('click', function (e) {
                ...
                if (confirm(BooklyL10n.are_you_sure)) {
                    $edit_form.html('<div class="bookly-loading"></div>');
                    $.post(ajaxurl, {action: 'bookly_delete_staff', id: staff_id}, function (response) {
                        $edit_form.html('');
            ...
            $('.bookly-thumb-delete').on('click', function () {
                ...
                $.post(ajaxurl, {action: 'bookly_delete_staff_avatar', id: staff_id}, function () {
                    $thumb.attr('style', '');
            ...
            $('#bookly-services-tab').on('click', function () {
                ...
                if (!$services_container.children().length) {
                    ...
                    $.post(ajaxurl, {action: 'bookly_staff_services', id: staff_id}, function (response) {
            ...
            $('#bookly-schedule-tab').on('click', function () {
                ...
                if (!$schedule_container.children().length) {
                    $loading_indicator.show();
                    $.post(ajaxurl, {action: 'bookly_staff_schedule', id: staff_id}, function (response) {
            ...
            $('#bookly-holidays-tab').on('click', function () {
                ...
                if (!$holidays_container.children().length) {
                    $loading_indicator.show();
                    $holidays_container.load(ajaxurl, { action: 'bookly_staff_holidays', id: staff_id }, function(){ $loading_indicator.hide(); });
                }
            });
