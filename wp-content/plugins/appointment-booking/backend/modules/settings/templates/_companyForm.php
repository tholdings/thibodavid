...
<form method="post" action="<?php echo esc_url( add_query_arg( 'tab', 'company' ) ) ?>" class="ab-settings-form">
    <div class="row">
        ...
        <div class="col-xs-9 col-lg-10">
            <div class="bookly-flex-cell bookly-vertical-middle">
                <?php \Bookly\Lib\Utils\Common::optionText( __( 'Company name', 'bookly' ), 'bookly_co_name' ) ?>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <?php \Bookly\Lib\Utils\Common::optionText( __( 'Phone', 'bookly' ), 'bookly_co_phone' ) ?>
    </div>
    <div class="form-group">
        <?php \Bookly\Lib\Utils\Common::optionText( __( 'Website', 'bookly' ), 'bookly_co_website' ) ?>
    </div>
