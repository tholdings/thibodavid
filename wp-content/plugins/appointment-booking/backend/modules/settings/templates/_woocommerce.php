...
<form method="post" action="<?php echo esc_url( add_query_arg( 'tab', 'woocommerce' ) ) ?>"
    ...
    <div class="form-group">
        <label for="bookly_wc_enabled">WooCommerce</label>
        <?php \Bookly\Lib\Utils\Common::optionToggle( 'bookly_wc_enabled' ) ?>
    </div>
    ...
    <div class="form-group">
        <?php \Bookly\Lib\Utils\Common::optionText( __( 'Cart item data', 'bookly' ), 'bookly_l10n_wc_cart_info_name' ) ?>
        <br/>
