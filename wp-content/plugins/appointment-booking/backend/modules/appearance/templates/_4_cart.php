...
<div class="bookly-form">
    ...
    <div class="ab-row">
        <span data-inputclass="input-xxlarge" data-notes="<?php echo esc_attr( $this->render( '_codes', array( 'step' => 4 ), false ) ) ?>" data-placement="bottom" data-default="<?php form_option( 'bookly_l10n_info_cart_step' ) ?>" class="ab_editable" id="ab-text-info-cart" data-type="textarea"><?php echo esc_html( get_option( 'bookly_l10n_info_cart_step' ) ) ?></span>
    </div>

    <div class="ab-row">
        <div class="ab-btn ab-add-item ab-inline-block">
            <span class="ab_editable" id="ab-text-button-book-more" data-type="text" data-default="<?php form_option( 'bookly_l10n_button_book_more' ) ?>"><?php echo esc_html( get_option( 'bookly_l10n_button_book_more' ) ) ?></span>
        </div>
    </div>
            ...
            <table>
                <thead class="ab-desktop-version">
                    <tr>
                        ...
                        <th data-default="<?php form_option( 'bookly_l10n_label_employee' ) ?>" class="ab-employee-list"><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_employee' ) ?></th>
                ...
                <tbody class="ab-mobile-version">
                    <tr>
                        <th data-default="<?php form_option( 'bookly_l10n_label_service' ) ?>" class="ab-service-list"><?php echo \Bookly\Lib\Utils\Common::getTranslatedOption( 'bookly_l10n_label_service' ) ?></th>
                        <td>Crown and Bridge</td>
                    </tr>
                    <tr>
                        <th><?php _e( 'Date', 'bookly' ) ?></th>
