...
<div class="bookly-form">
    ...
    <div class="ab-service-step">
        <div class="ab-row">
            <span data-default="<?php form_option( 'bookly_l10n_info_service_step' ) ?>"
        ...
        <div class="ab-mobile-step_1 ab-row">
            <div class="bookly-js-chain-item bookly-table ab-row">
                <?php if ( \Bookly\Lib\Config::isLocationsEnabled() ) : ?>
                    <div class="ab-formGroup">
                        <?php do_action( 'bookly_locations_render_appearance' ) ?>
                    </div>
                <?php endif ?>
                <div class="ab-formGroup">
                    <label data-default="<?php form_option( 'bookly_l10n_label_category' ) ?>"
                           class="text_category_label"
                           id="ab-text-label-category" data-type="multiple"
                           data-option-id="ab-text-option-category"
                    ><?php echo esc_html( get_option( 'bookly_l10n_label_category' ) ) ?></label>
                    <div>
                        <select class="ab-select-mobile ab-select-category">
                            <option value="" class="editable" id="ab-text-option-category" data-default="<?php form_option( 'bookly_l10n_option_category' ) ?>"><?php echo esc_html( get_option( 'bookly_l10n_option_category' ) ) ?></option>
                ...
                <div class="ab-formGroup">
                    <label>
                        <span
                            data-default="<?php form_option( 'bookly_l10n_label_service' ) ?>"
                            data-default-error="<?php form_option( 'bookly_l10n_required_service' ) ?>"
                            data-error-id="bookly_l10n_required_service"
                            id="ab-text-label-service"
                            data-mirror="text_services"
                            data-type="multiple"
                            data-option-id="ab-text-option-service"
                        ><?php echo esc_html( get_option( 'bookly_l10n_label_service' ) ) ?></span>
                    </label>
                    <div>
                        <select class="ab-select-mobile ab-select-service">
                            <option class="editable" id="ab-text-option-service" data-default="<?php form_option( 'bookly_l10n_option_service' ) ?>"><?php echo esc_html( get_option( 'bookly_l10n_option_service' ) ) ?></option>
                ...
                <div class="ab-formGroup">
                    <label class="text_employee_label">
                        <span
                            data-default="<?php form_option( 'bookly_l10n_label_employee' ) ?>"
                            data-default-error="<?php form_option( 'bookly_l10n_required_employee' ) ?>"
                            data-error-id="bookly_l10n_required_employee"
                            id="ab-text-label-employee"
                            data-mirror="text_employee"
                            data-type="multiple"
                            data-option-id="ab-text-option-employee"
                        ><?php echo esc_html( get_option( 'bookly_l10n_label_employee' ) ) ?></span>
                        </label>
                    <div>
                        <select class="ab-select-mobile ab-select-employee">
                            <option value="0" class="editable" id="ab-text-option-employee" data-default="<?php form_option( 'bookly_l10n_option_employee' ) ?>"><?php echo esc_html( get_option( 'bookly_l10n_option_employee' ) ) ?></option>
                ...
                <div class="ab-formGroup">
                    <label data-default="<?php form_option( 'bookly_l10n_label_number_of_persons' ) ?>" class="ab_editable" data-type="text" id="ab-text-label-number-of-persons"><?php echo esc_html( get_option( 'bookly_l10n_label_number_of_persons' ) ) ?></label>
                    <div>
                ...
                <?php if ( \Bookly\Lib\Config::isMultiplyAppointmentsEnabled() ) : ?>
                    <div class="ab-formGroup">
                        <?php do_action( 'bookly_multiply_appointments_render_appearance' ) ?>
                    </div>
                <?php endif ?>
                <?php if ( \Bookly\Lib\Config::isChainAppointmentsEnabled() ) : ?>
                    <div class="ab-formGroup">
                        <label></label>
            ...
            <div class="ab-right ab-mobile-next-step ab-btn ab-none" onclick="return false">
                <span class="text_next ab_editable" id="ab-text-button-next" data-mirror="text_next" data-type="text" data-default="<?php form_option( 'bookly_l10n_button_next' ) ?>"><?php echo esc_html( get_option( 'bookly_l10n_button_next' ) ) ?></span>
            </div>
        </div>
        <div class="ab-mobile-step_2">
            <div class="ab-row">
                <div class="ab-left">
                    <div class="ab-available-date ab-left">
                        <div class="ab-formGroup">
                            <label data-default="<?php form_option( 'bookly_l10n_label_select_date' ) ?>" class="ab_editable" id="ab-text-label-select_date" data-type="text"><?php echo esc_html( get_option( 'bookly_l10n_label_select_date' ) ) ?></label>
                            <div>
                ...
                <div class="ab-time-range ab-left">
                    <div class="ab-formGroup ab-time-from ab-left">
                        <label data-default="<?php form_option( 'bookly_l10n_label_start_from' ) ?>" class="ab_editable" id="ab-text-label-start_from" data-type="text"><?php echo esc_html( get_option( 'bookly_l10n_label_start_from' ) ) ?></label>
                        <div>
                    ...
                    <div class="ab-formGroup ab-time-to ab-left">
                        <label data-default="<?php form_option( 'bookly_l10n_label_finish_by' ) ?>" class="ab_editable" id="ab-text-label-finish_by" data-type="text"><?php echo esc_html( get_option( 'bookly_l10n_label_finish_by' ) ) ?></label>
                        <div>
            ...
            <div class="ab-row ab-nav-steps">
                <div class="ab-right ab-mobile-prev-step ab-btn ab-none">
                    <span class="text_back ab_editable" id="ab-text-button-back" data-mirror="text_back" data-type="text" data-default="<?php form_option( 'bookly_l10n_button_back' ) ?>"><?php echo esc_html( get_option( 'bookly_l10n_button_back' ) ) ?></span>
                </div>
