...
<div class="bookly-form">
    ...
    <div class="ab-row">
        <span data-inputclass="input-xxlarge" data-notes="<?php echo esc_attr( $this->render( '_codes', array( 'step' => 3 ), false ) ) ?>" data-placement="bottom" data-default="<?php form_option( 'bookly_l10n_info_time_step' ) ?>" class="ab_editable" id="ab-text-info-time" data-type="textarea"><?php echo esc_html( get_option( 'bookly_l10n_info_time_step' ) ) ?></span>
    </div>
    <!-- timeslots -->
        ...
        <div class="ab-columnizer">
            <div class="ab-time-screen ab-day-columns" style="display: <?php echo get_option( 'bookly_app_show_day_one_column' ) == 1 ? ' none' : 'block' ?>">
                ...
                <div class="ab-column col3" style="display: <?php echo get_option( 'bookly_app_show_calendar' ) == 1 ? ' none' : 'inline-block' ?>">
                    ...
                    <?php endfor ?>
                    <button class="ab-day ab-first-child"><?php echo date_i18n( 'D, M d', strtotime( '+2 day', current_time( 'timestamp' ) ) ) ?></button>
                ...
                <div class="ab-column col4" style="display: <?php echo get_option( 'bookly_app_show_calendar' ) == 1 ? ' none' : 'inline-block' ?>">
                    ...
                    <?php endfor ?>
                    <button class="ab-day ab-first-child"><?php echo date_i18n( 'D, M d', strtotime( '+3 day', current_time( 'timestamp' ) ) ) ?></button>
                ...
                <div class="ab-column col5" style="display:<?php echo get_option( 'bookly_app_show_calendar' ) == 1 ? ' none' : ' inline-block' ?>">
                    ...
                    <?php endfor ?>
                    <button class="ab-day ab-first-child"><?php echo date_i18n( 'D, M d', strtotime( '+4 day', current_time( 'timestamp' ) ) ) ?></button>
                ...
                <div class="ab-column col6" style="display: <?php echo get_option( 'bookly_app_show_calendar' ) == 1 ? ' none' : 'inline-block' ?>">
                    ...
                    <?php endfor ?>
                    <button class="ab-day ab-first-child"><?php echo date_i18n( 'D, M d', strtotime( '+5 day', current_time( 'timestamp' ) ) ) ?></button>
                ...
                <div class="ab-column col7" style="display:<?php echo get_option( 'bookly_app_show_calendar' ) == 1 ? ' none' : ' inline-block' ?>">
                    ...
                    <?php endfor ?>
                    <button class="ab-day ab-first-child"><?php echo date_i18n( 'D, M d', strtotime( '+6 day', current_time( 'timestamp' ) ) ) ?></button>
            ...
            <div class="ab-time-screen ab-day-one-column" style="display: <?php echo get_option( 'bookly_app_show_day_one_column' ) == 1 ? ' block' : 'none' ?>">
                ...
                <?php for ( $i = 1; $i <= 7; ++ $i ) : ?>
                    <div class="ab-column col<?php echo $i ?>">
                        <button class="ab-day ab-first-child"><?php echo date_i18n( 'D, M d', strtotime( '+' . ( $i - 1 ) . ' day', current_time( 'timestamp' ) ) ) ?></button>
