    ...
    $save_button.on('click', function(e) {
        ...
        var data = {
            ...
            options: {
                ...
                // Validator.
                'text_required_location'       : getEditableValue($('#bookly_app_text_required_location').html()),
                'text_required_service'        : getEditableValue($('#bookly_app_text_required_service').html()),
                'text_required_employee'       : getEditableValue($('#bookly_app_text_required_employee').html()),
                'text_required_name'           : getEditableValue($('#bookly_app_text_required_name').html()),
                'text_required_phone'          : getEditableValue($('#bookly_app_text_required_phone').html()),
                'text_required_email'          : getEditableValue($('#bookly_app_text_required_email').html()),
                // Checkboxes.
