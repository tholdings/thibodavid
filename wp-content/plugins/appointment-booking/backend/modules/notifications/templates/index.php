                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="sender_email" name="bookly_email_sender" class="form-control ab-inline-block ab-auto-w ab-sender" type="text" value="<?php echo esc_attr( $bookly_email_sender ) ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="bookly_email_content_type">
                                ...
                                <?php \Bookly\Lib\Utils\Common::optionToggle( 'bookly_email_content_type', array( 't' => array( 'html', __( 'HTML',  'bookly' ) ), 'f' => array( 'plain', __( 'Text', 'bookly' ) ) ) ) ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="bookly_email_reply_to_customers">
                                ...
                                <?php \Bookly\Lib\Utils\Common::optionToggle( 'bookly_email_reply_to_customers' ) ?>
                            </div>
                        </div>
                    </div>
