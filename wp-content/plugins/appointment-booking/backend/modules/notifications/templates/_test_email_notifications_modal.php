                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input id="ab_sender_name" class="form-control" type="text" ng-model="dataSource.bookly_email_sender_name"/>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="ab_sender_email"><?php _e( 'Sender email', 'bookly' ) ?></label>
                                        <input id="ab_sender_email" class="form-control" type="text" ng-model="dataSource.bookly_email_sender"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
