            ...
            loadData  : function(params) {
                ...
                jQuery.ajax({
                    ...
                    success  : function(response) {
                        if (response.success) {
                            ds.bookly_email_sender_name = response.data.bookly_email_sender_name;
                            ds.bookly_email_sender  = response.data.bookly_email_sender;
    ...
    module.controller('testEmailNotificationsDialogCtrl', function($scope, dataSource, $timeout) {
        ...
        $scope.testEmailNotifications = function(){
            var data = {
                ...
                bookly_email_sender_name : $scope.dataSource.bookly_email_sender_name,
                bookly_email_sender : $scope.dataSource.bookly_email_sender,
                reply_to_customers : angular.element('#ab_test_email_notifications_dialog #bookly_email_reply_to_customers').val(),
                content_type : angular.element('#ab_test_email_notifications_dialog #bookly_email_content_type').val()
            };
